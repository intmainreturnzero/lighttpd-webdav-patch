...
source=("https://download.lighttpd.net/lighttpd/releases-1.4.x/lighttpd-${pkgver}.tar.xz"{,.asc}
        'lighttpd.logrotate.d' 'lighttpd.conf' 'lighttpd.tmpfiles' 'lighttpd.service' 'webdav.patch')
sha512sums=('aa180a2751711a77b9da91a6a285c967d2c183ccbabe3e9064aea74e44629c3b0227ac98c7d720c8d4d223ce4b31e8b221b05b928adc917b199ab1015fcdba37'
            ...
            '087d47080324678c2e9a9e4d0c91aeb7efb75733cd1ede5e66def7bdf83c2f0efb3e33c959604cb85d71ef235f584b66e201aff2335a6b24136be26a43048943')
...
prepare() {
	...
	patch --forward --strip=1 --input="${srcdir}/webdav.patch"
}
